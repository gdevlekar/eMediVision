        ...
        private void dataGridView1_CellEndEdit(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (selectedRow.Cells[0].Value != null)
                if (Int32.TryParse(selectedRow.Cells[0].Value.ToString(), out v))
                {
                    ...
                    SQL = "select   DrugName,Packing,Comp,Shelf,BatchNo,ExpiryDate,MRP,Qty,Amount from products where ID =" + selectedRow.Cells[0].Value;
                ...
                else
                {
                    ...
                    SQL = "select   DrugName,Packing,Comp,Shelf,BatchNo,ExpiryDate,MRP,Qty,Amount from products where DrugName ='" + selectedRow.Cells[0].Value + "'";
